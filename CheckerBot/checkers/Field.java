...
public class Field {
	...
	public static final int startY = 55;
...
//	private static final int endY = 437;
	...
	public final static String[] getNameByNumber = { "dark", "white", "pink", "pink_q",
			"yellow", "yellow_q" };

	Field() throws IOException, AWTException {
	...
	public String[][] getCurrentField() throws FileNotFoundException, IOException,
			Exception {
		Thread.sleep(100);
